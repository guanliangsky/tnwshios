#!/usr/bin/env python3
"""
Final comprehensive script to clean up ALL duplicate lesson entries
This will remove ALL duplicates and merge into a single clean instructions object
"""

import re
import os

def cleanup_duplicates_final():
    """Remove ALL duplicate lesson entries and merge into single object"""
...
def main():
    ...
    os.system('cp index.html index_backup_before_final_cleanup.html')
    
    # Clean up duplicates
    success = cleanup_duplicates_final()
    
    if success:
        print("\n🎉 Final cleanup completed successfully!")
        print("📁 Backup saved as: index_backup_before_final_cleanup.html")
        print("📊 Check the file size difference:")
        os.system('ls -lh index.html index_backup_before_final_cleanup.html')
