#!/usr/bin/env python3
"""
Complete cleanup script to remove ALL duplicates and merge into single object
...
def cleanup_duplicates_complete():
    """Remove ALL duplicates and create single clean instructions object"""
    
    print("Starting complete duplicate cleanup...")
    ...
    if match:
        ...
        print("✅ Complete cleanup completed successfully!")
        return True
    else:
...
def main():
    ...
    os.system('cp index.html index_backup_before_complete_cleanup.html')
    
    # Clean up duplicates
    success = cleanup_duplicates_complete()
    
    if success:
        print("\n🎉 Complete cleanup completed successfully!")
        print("📁 Backup saved as: index_backup_before_complete_cleanup.html")
        print("📊 Check the file size difference:")
        os.system('ls -lh index.html index_backup_before_complete_cleanup.html')
